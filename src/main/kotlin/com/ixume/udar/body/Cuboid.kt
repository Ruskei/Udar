...
import com.ixume.udar.physics.mesh.Axis
import com.ixume.udar.physics.mesh.Edge
import com.ixume.udar.physics.mesh.Mesh
import com.ixume.udar.physics.mesh.Mesh.Companion.INNER
import com.ixume.udar.physics.mesh.MeshFace
    ...
    private fun maxChange(): Double {
        return velocity.length() * TIME_STEP +
                Vector3d(width * 0.5, height * 0.5, length * 0.5).rotate(q)
                    .distance(Vector3d(width * 0.5, height * 0.5, length * 0.5).rotate(prevQ)) + Udar.CONFIG.collision.passiveSlop
    }
...
//            println("  - cachedMesh.end: ${cachedMesh.end}")
    ...
    private var prevMaxDepth = Udar.CONFIG.collision.passiveSlop
